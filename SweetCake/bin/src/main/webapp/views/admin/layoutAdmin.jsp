...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="/avatar.jpg" width="50px"
        alt="User Image">
      <div>
    ...
    <ul class="app-menu">
      <li><a class="app-menu__item haha" href="#"><i class='app-menu__icon bx bx-cart-alt'></i>
          <span class="app-menu__label">Dash Board</span></a></li>
      ...
      <li><a class="app-menu__item active" href="#"><i class='app-menu__icon bx bx-id-card'></i>
          <span class="app-menu__label">Admin</span></a></li>
      ...
      <li><a class="app-menu__item" href="#"><i class='app-menu__icon bx bx-task'></i><span
            class="app-menu__label">Admin</span></a></li>
      <li><a class="app-menu__item" href="#"><i class='app-menu__icon bx bx-run'></i><span class="app-menu__label">Admin
          </span></a></li>
    </ul>
  </aside>
  <main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb side">
        <li class="breadcrumb-item active"><a href="#"><b>Danh sách </b></a></li>
      </ul>
      <div id="clock"></div>
    </div>
