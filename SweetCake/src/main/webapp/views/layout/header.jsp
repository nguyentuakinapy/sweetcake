        ...
        <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="${url}home"><i class="bi bi-house me-2"></i>Trang Chủ</a></li>
                    <li class="nav-item"><a class="nav-link" href="${url}product/list"><i class="bi bi-cake2 me-2"></i>Sản phẩm</a></li>
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-card-list me-2"></i>Danh Mục</a>
                        <ul class="dropdown-menu">
                            <c:forEach var="lb" items="${lbList}">
                                <li><a class="dropdown-item" href="${url}loaibanh/${lb.maLoaiBanh}">${lb.tenLoaiBanh}</a></li>
                            </c:forEach>
                        </ul>
                    </li>
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="bi bi-person-circle me-2"></i>${ttdn}</a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#"><i class="bi bi-bag-check me-2"></i>Giỏ Hàng</a></li>
                </ul>
            </div>
        </nav>
    </div>
